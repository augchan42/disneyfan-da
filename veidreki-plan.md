...
*Goal: Get a Veidreki dragon. Last updated March 19, 2026.*
...
## Phase 1: Veidreki Token (URGENT — event ends April 3, 2026)

> **This is the time-limited piece. Cannot be obtained after the event ends.**

### How to get it

Collect **36 Stormbound Eggs from the Event Pass** → fills the Veidreki Token meter.

> **IMPORTANT:** Only Stormbound Eggs earned from Event Pass tiers count toward the token meter. Eggs from daily/repeatable missions do NOT count — those are separate (useful for Archie's Shop items).

### How Event Pass eggs work

- Event Pass resets **daily at 7:00 PM EST**
- Requires **10 missions** to complete all 10 tiers (3 dailies + 7 repeatables)
...
Those can be spent at **Archie's Shop** for:
- Voltage Theme Potion (2 eggs)
- Nesting Site Theme (6 eggs, one-time)
- Voltage Fishing Rod (2 eggs, one-time)
- Buildings and Accessories (check shop tabs)

Save or spend as she likes — they don't affect the Veidreki Token.

---

## Phase 2: 3 More Legacy Tokens (long-term, no rush)

### How Legacy Tokens are earned

| Source | Tokens | Cost | Points Required |
|--------|--------|------|-----------------|
| Dragon Season Free Pass tier 48 | 1/season | Free | 8,338 Season Points |
| Dragon Season Drakon Pass tier 99 | 1/season | 749 Robux | 18,599 Season Points |

### Timeline (F2P)

| Season | Dates (approx) | Legacy Token |
|--------|----------------|--------------|
| Season 3 | Mar 6 – Apr 6 | ✅ Done! |
| **Season 4** | **~May 2026** | **Token #5** |
| **Season 5** | **~June 2026** | **Token #6 — DONE!** |

### The chill grind

After the Veidreki event ends (April 3), she just needs to:
- Do daily/weekly Season missions each month to reach tier 48
- This is a much lighter commitment than the event grind
- No time pressure — seasons come every month

---

## Alternative: Trade for a Veidreki (~20M gold)

- Veidreki is worth ~20M gold in trades (per player estimate)
- The wiki value lists show 600-700M but real trade values vary
- The Veidreki dragon itself IS tradable (Veidreki Egg is NOT)

**Not needed** — she's on track for F2P by June 2026.
